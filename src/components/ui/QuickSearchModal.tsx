...
const searchableDatabase: SearchItem[] = [
  ...
  { title: "CBSE Curriculum (Grade VI to Class XII)", category: "Academics", description: "Rigorous national board with integrated JEE/NEET/CUET coaching and science/commerce streams", href: "/academics" },
  { title: "International Baccalaureate (IB PYP)", category: "Academics", description: "Inquiry-based international curriculum fostering self-directed query and global mindedness", href: "/academics", badge: "IB World School" },
