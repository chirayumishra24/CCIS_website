...
const searchableDatabase: SearchItem[] = [
  ...
  { title: "Faculty & Educator Directory", category: "Faculty", description: "Meet our director, principal, vice principal, IB coordinators, and subject specialists", href: "/faculty" },
