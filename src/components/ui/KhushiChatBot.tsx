...
import { MessageSquare, X, Send, Phone, ArrowUpRight, Sparkles, User, CheckCircle2 } from "lucide-react";
    ...
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-16 right-4 sm:bottom-20 sm:right-6 w-[calc(100vw-2rem)] sm:w-[380px] max-h-[580px] h-[520px] bg-white rounded-3xl shadow-2xl border border-cream-line flex flex-col overflow-hidden z-50 animate-fadeIn">
          {/* Header */}
          <div className="bg-gradient-to-r from-navy-dark via-navy to-[#182f65] p-4 text-white flex items-center justify-between shrink-0 border-b border-gold/30">
            <div className="flex items-center gap-3">
              <div className="relative">
                <div className="w-10 h-10 rounded-full bg-gold text-navy flex items-center justify-center font-bold text-sm shadow-md border-2 border-white/20">
                  K
                </div>
                <span className="absolute bottom-0 right-0 w-3 h-3 bg-emerald-500 border-2 border-navy rounded-full" />
              </div>
              <div>
                <div className="flex items-center gap-1.5">
                  <h4 className="font-serif font-bold text-white text-base">Khushi</h4>
                  <span className="text-[10px] bg-gold/20 text-gold font-mono px-1.5 py-0.5 rounded border border-gold/30">
                    AI Guide
                  </span>
                </div>
                <p className="text-[11px] text-white/75 flex items-center gap-1">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping inline-block" />
                  Online | CCIS Admissions
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-1.5">
              <a
                href="https://wa.me/919660551977?text=Hello%20CCIS,%20I%20would%20like%20to%20enquire%20about%20admissions."
                target="_blank"
                rel="noopener noreferrer"
                className="p-1.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-full transition-colors"
              ...
              <a
                ...
                className="p-1.5 bg-white/10 hover:bg-white/20 text-gold rounded-full transition-colors"
