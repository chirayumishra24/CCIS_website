      ...
      <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4 mt-2">
            <a href="https://www.facebook.com/CambridgeCourtGroupOfSchools" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 hover:bg-gold hover:text-navy rounded-full transition-all duration-300" aria-label="Facebook">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/cambridgecourtgroupofschools/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 hover:bg-gold hover:text-navy rounded-full transition-all duration-300" aria-label="Instagram">
            ...
            <a href="https://www.youtube.com/@CambridgeCourtGroupofSchools" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 hover:bg-gold hover:text-navy rounded-full transition-all duration-300" aria-label="YouTube">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            ...
            <a href="https://www.linkedin.com/school/cambridge-court-group-of-schools/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 hover:bg-gold hover:text-navy rounded-full transition-all duration-300" aria-label="LinkedIn">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
