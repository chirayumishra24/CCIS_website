...
export default function NewsEvents() {
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* Banner */}
      <section className="relative bg-navy text-white py-32 md:py-40 lg:py-44 overflow-hidden border-b-4 border-gold">
        <div className="absolute inset-0 bg-cover bg-center opacity-25" style={{ backgroundImage: "url('/images/news_events_hero.png')" }} />
