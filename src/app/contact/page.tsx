...
const faqs = [
  ...
  { q: "What curriculum does CCIS follow?", a: "CCIS offers both the CBSE national board from Grade VI to Class XII, and the IB Primary Years Programme (PYP) for Ages 3-12." },
